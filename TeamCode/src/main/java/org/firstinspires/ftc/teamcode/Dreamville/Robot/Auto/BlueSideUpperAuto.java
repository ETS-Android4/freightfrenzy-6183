                ...
                case CAROUSEL:
                    if (!carousel.isBusy()) {
                        ...
                        TrajectorySequence trajectory2 = drive.trajectorySequenceBuilder(poseEstimate)
                                .lineToLinearHeading(new Pose2d(-8, 44, Math.toRadians(270)))
                                .build();
                ...
                case PICKUP_1:
                    if (!intake.isBusy()) {
                        ...
                        TrajectorySequence trajectory4 = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .splineToSplineHeading(new Pose2d(-8, 44, Math.toRadians(270)), Math.toRadians(180))
                                .build();
                ...
                case PICKUP_2:
                    if (!intake.isBusy()) {
                        ...
                        TrajectorySequence trajectory6 = drive.trajectorySequenceBuilder(poseEstimate)
                                .lineToConstantHeading(new Vector2d(10, 65))
                                .splineToSplineHeading(new Pose2d(0, 44, Math.toRadians(270)), Math.toRadians(180))
                                .build();
